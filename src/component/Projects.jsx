...
const {img,technologies,title,date,description,codeLink,liveLink} = projectData[0];


const Projects = () => {
  return (
    <section id='projects' className='common-section-style bg-[#191924]'>

        <h2 className='common-h2'> Projects </h2>
        <p className='custom-mute text-center my-5'> I have experience doing some projects. Here are a few examples of my work. </p>
