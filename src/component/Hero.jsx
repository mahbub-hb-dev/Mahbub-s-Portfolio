    ...
    <div id="about" className="bg-[#191924] mt-[74px]">
      ...
      <div className="max-w-[1180px] mx-auto py-10 px-3 lg:flex lg:flex-row-reverse">
        ...
        <div className="lg:flex-1">
          <h1 className="font-bold text-[40px] sm:text-[50px] text-white text-center lg:text-left"> {" "} Hi, I am {" "} <span className="block leading-16 text-pink-500">Mahbub Hasan (Belal)</span> </h1>
          ...
          <a href="#" className="animate-bounce focus:animate-none hover:animate-none block w-[230px] sm:w-[300px] mx-auto sm:text-2xl font-medium text-xl bg-[#5C07A9] px-4 py-4 rounded-lg tracking-wide text-white text-center">
            {" "} Check Resume 🏀 {" "}
          </a>
        </div>
      </div>
